...
public interface EncounterHistoryTableConstant
{

	String TABLE_NAME = "EncounterInformationHistory";

	String ID = "encounter_history_id";

	String ENCOUNTER_ID = "encounterIndexid";
